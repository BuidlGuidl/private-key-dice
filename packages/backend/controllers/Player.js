    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                token = void 0;
                if (JWT_SECRET)
                    token = jsonwebtoken_1.default.sign({ address: playerAddress }, JWT_SECRET);
...
var leave = function () { };
exports.leave = leave;
var sweepPrize = function () { };
exports.sweepPrize = sweepPrize;
var markSlotsAsFoundPerPlayer = function () { };
exports.markSlotsAsFoundPerPlayer = markSlotsAsFoundPerPlayer;
